...
const Question = () => {
  ...
  const submitHandler = async (event) => {
    ...
    const language = selectedLang || "cpp";
  ...
  const runCodeHandler = async () => {
    ...
    setcodeSubmittingState("submitting");
    try {
      const query = await fetch(`${SERVER_LINK}/api/explore/codeExecutor`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: "POST",
          ...
          <div className={classes.notHead}>
            ...
            <div className={classes.submitBtn}>
              <div>
                <div className={classes.codeSnippet}>
                  ...
                  {codeSubmittingState === "submitting"
                    ...
                    ? "Enter Custom input and then run"
                    : "Enter Custom input and then run"}
                  &#160;/&#62;
                </div>
                <textarea
                  ...
                  placeholder="Enter Custom input to run..."
              ...
              <div style={{ display: "flex", gap: "1em" }}>
                <ButtonCustom onClick={runCodeHandler} color="pink">
                  {codeSubmittingState === "submitting" ? "Running" : "Run"}
                ...
                <ButtonCustom
                  ...
                  color="green"
                  disabled={codeSubmittingState === "submitting"}
                >
